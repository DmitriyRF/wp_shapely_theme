...
/*!
 * Froala Code View, Links & UI and ULs
 * License https://froala.com/wysiwyg-editor/terms/
 * Copyright 2014-2016 Froala Labs
 */
!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof module&&module.exports?module.exports=function(t,n){return void 0===n&&(n="undefined"!=typeof window?require("jquery"):require("jquery")(t)),e(n),n}:e(jQuery)}(function(e){"use strict";e.extend(e.FE.DEFAULTS,{codeMirror:!0,codeMirrorOptions:{lineNumbers:!0,tabMode:"indent",indentWithTabs:!0,lineWrapping:!0,mode:"text/html",tabSize:2}}),e.FE.PLUGINS.codeView=function(t){function n(){return t.$box.hasClass("fr-code-view")}function i(){return d?d.getValue():f.val()}function r(e){var n=i();t.html.set(n),t.$el.blur(),t.$tb.find(" > .fr-command").not(e).removeClass("fr-disabled"),e.removeClass("fr-active"),t.events.focus(!0),t.placeholder.refresh(),t.undo.saveStep()}function a(e,n){f||l(),!d&&t.opts.codeMirror&&"undefined"!=typeof CodeMirror&&(d=CodeMirror.fromTextArea(f.get(0),t.opts.codeMirrorOptions)),t.undo.saveStep(),t.html.cleanEmptyTags(),t.html.cleanWhiteTags(!0),t.core.hasFocus()&&(t.core.isEmpty()||(t.selection.save(),t.$el.find('.fr-marker[data-type="true"]:first').replaceWith('<span class="fr-tmp fr-sm">F</span>'),t.$el.find('.fr-marker[data-type="false"]:last').replaceWith('<span class="fr-tmp fr-em">F</span>')),t.$el.blur());var i=t.html.get(!1,!0);t.$el.find("span.fr-tmp").remove(),i=i.replace(/<span class="fr-tmp fr-sm">F<\/span>/,"FROALA-SM"),i=i.replace(/<span class="fr-tmp fr-em">F<\/span>/,"FROALA-EM"),t.codeBeautifier&&(i=t.codeBeautifier.run(i,{end_with_newline:!0,indent_inner_html:!0,extra_liners:["p","h1","h2","h3","h4","h5","h6","blockquote","pre","ul","ol","table","dl"],brace_style:"expand",indent_char:"  ",indent_size:1,wrap_line_length:0}));var r,a;if(d){r=i.indexOf("FROALA-SM"),a=i.indexOf("FROALA-EM"),r>a?r=a:a-=9,i=i.replace(/FROALA-SM/g,"").replace(/FROALA-EM/g,"");var s=i.substring(0,r).length-i.substring(0,r).replace(/\n/g,"").length,o=i.substring(0,a).length-i.substring(0,a).replace(/\n/g,"").length;r=i.substring(0,r).length-i.substring(0,i.substring(0,r).lastIndexOf("\n")+1).length,a=i.substring(0,a).length-i.substring(0,i.substring(0,a).lastIndexOf("\n")+1).length,d.setSize(null,Math.max(n,150)),d.setValue(i),d.focus(),d.setSelection({line:s,ch:r},{line:o,ch:a}),d.refresh(),d.clearHistory()}else r=i.indexOf("FROALA-SM"),a=i.indexOf("FROALA-EM")-9,f.css("height",n),(t.opts.height||t.opts.heightMax)&&f.css("max-height",t.opts.height||t.opts.heightMax),f.val(i.replace(/FROALA-SM/g,"").replace(/FROALA-EM/g,"")),f.focus(),f.get(0).setSelectionRange(r,a);t.$tb.find(" > .fr-command").not(e).addClass("fr-disabled"),e.addClass("fr-active"),!t.helpers.isMobile()&&t.opts.toolbarInline&&t.toolbar.hide()}function s(e){"undefined"==typeof e&&(e=!n());var i=t.$tb.find('.fr-command[data-cmd="html"]');if(e){t.popups.hideAll();var s=t.$wp.outerHeight();t.$box.toggleClass("fr-code-view",!0),a(i,s)}else t.$box.toggleClass("fr-code-view",!1),r(i)}function o(){n()&&(s(t.$tb.find('button[data-cmd="html"]')),f.val("").removeData().remove()),c&&c.remove()}function l(){f=e('<textarea class="fr-code" tabindex="-1">'),t.$wp.append(f),f.attr("dir",t.opts.direction),t.opts.toolbarInline&&(c=e('<a data-cmd="html" title="Code View" class="fr-command fr-btn html-switch'+(t.helpers.isMobile()?"":" fr-desktop")+'" role="button" tabindex="-1"><i class="fa fa-code"></i></button>'),t.$box.append(c),t.events.bindClick(t.$box,"a.html-switch",function(){s(!1)}));var r=function(){return!n()};t.events.on("buttons.refresh",r),t.events.on("copy",r,!0),t.events.on("cut",r,!0),t.events.on("paste",r,!0),t.events.on("destroy",o,!0),t.events.on("html.set",function(){n()&&s(!0)}),t.events.on("form.submit",function(){n()&&(t.html.set(i()),t.events.trigger("contentChanged",[],!0))},!0)}function p(){return t.$wp?void 0:!1}var f,d,c;return{_init:p,toggle:s,isActive:n,get:i}},e.FE.RegisterCommand("html",{title:"Code View",undo:!1,focus:!1,forcedRefresh:!0,callback:function(){this.codeView.toggle()},plugin:"codeView"}),e.FE.DefineIcon("html",{NAME:"code"})}),!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof module&&module.exports?module.exports=function(t,n){return void 0===n&&(n="undefined"!=typeof window?require("jquery"):require("jquery")(t)),e(n),n}:e(jQuery)}(function(e){"use strict";e.FE.PLUGINS.lists=function(t){function n(e){return'<span class="fr-open-'+e.toLowerCase()+'"></span>'}function i(e){return'<span class="fr-close-'+e.toLowerCase()+'"></span>'}function r(t,n){for(var i=[],r=0;r<t.length;r++){var a=t[r].parentNode;"LI"==t[r].tagName&&a.tagName!=n&&i.indexOf(a)<0&&i.push(a)}for(r=i.length-1;r>=0;r--){var s=e(i[r]);s.replaceWith("<"+n.toLowerCase()+">"+s.html()+"</"+n.toLowerCase()+">")}}function a(n,i){r(n,i);for(var a=t.html.defaultTag(),s=0;s<n.length;s++)"LI"!=n[s].tagName&&(a&&n[s].tagName.toLowerCase()==a?e(n[s]).replaceWith("<"+i+"><li"+t.node.attributes(n[s])+">"+e(n[s]).html()+"</li></"+i+">"):e(n[s]).wrap("<"+i+"><li></li></"+i+">"));t.clean.lists()}function s(r){var a,s;for(a=r.length-1;a>=0;a--)for(s=a-1;s>=0;s--)if(e(r[s]).find(r[a]).length||r[s]==r[a]){r.splice(a,1);break}var o=[];for(a=0;a<r.length;a++){var l=e(r[a]),p=r[a].parentNode;l.before(i(p.tagName)),"LI"==p.parentNode.tagName?(l.before(i("LI")),l.after(n("LI"))):(t.node.isEmpty(l.get(0),!0)||0!==l.find(t.html.blockTagsQuery()).length||l.append("<br>"),l.append(n("LI")),l.prepend(i("LI"))),l.after(n(p.tagName)),"LI"==p.parentNode.tagName&&(p=p.parentNode.parentNode),o.indexOf(p)<0&&o.push(p)}for(a=0;a<o.length;a++){var f=e(o[a]),d=f.html();d=d.replace(/<span class="fr-close-([a-z]*)"><\/span>/g,"</$1>"),d=d.replace(/<span class="fr-open-([a-z]*)"><\/span>/g,"<$1>"),f.replaceWith(t.node.openTagString(f.get(0))+d+t.node.closeTagString(f.get(0)))}t.$el.find("li:empty").remove(),t.$el.find("ul:empty, ol:empty").remove(),t.clean.lists(),t.html.wrap()}function o(e,t){for(var n=!0,i=0;i<e.length;i++){if("LI"!=e[i].tagName)return!1;e[i].parentNode.tagName!=t&&(n=!1)}return n}function l(e){t.selection.save(),t.html.wrap(!0,!0),t.selection.restore();for(var n=t.selection.blocks(),i=0;i<n.length;i++)"LI"!=n[i].tagName&&"LI"==n[i].parentNode.tagName&&(n[i]=n[i].parentNode);t.selection.save(),o(n,e)?s(n):a(n,e),t.html.unwrap(),t.selection.restore()}function p(n,i){var r=e(t.selection.element());if(r.get(0)!=t.$el.get(0)){var a=r.get(0);"LI"!=a.tagName&&(a=r.parents("li").get(0)),a&&a.parentNode.tagName==i&&t.$el.get(0).contains(a.parentNode)&&n.addClass("fr-active")}}function f(n){t.selection.save();for(var i=0;i<n.length;i++){var r=n[i].previousSibling;if(r){var a=e(n[i]).find("> ul, > ol").get(0);if(a){for(var s=e("<li>").prependTo(e(a)),o=t.node.contents(n[i])[0];o&&!t.node.isList(o);){var l=o.nextSibling;s.append(o),o=l}e(r).append(e(a)),e(n[i]).remove()}else{var p=e(r).find("> ul, > ol").get(0);if(p)e(p).append(e(n[i]));else{var f=e("<"+n[i].parentNode.tagName+">");e(r).append(f),f.append(e(n[i]))}}}}t.clean.lists(),t.selection.restore()}function d(e){t.selection.save(),s(e),t.selection.restore()}function c(e){if("indent"==e||"outdent"==e){for(var n=!1,i=t.selection.blocks(),r=[],a=0;a<i.length;a++)"LI"==i[a].tagName?(n=!0,r.push(i[a])):"LI"==i[a].parentNode.tagName&&(n=!0,r.push(i[a].parentNode));n&&("indent"==e?f(r):d(r))}}function u(){t.events.on("commands.after",c),t.events.on("keydown",function(n){if(n.which==e.FE.KEYCODE.TAB){for(var i,r=t.selection.blocks(),a=[],s=0;s<r.length;s++)"LI"==r[s].tagName?(i=!0,a.push(r[s])):"LI"==r[s].parentNode.tagName&&(i=!0,a.push(r[s].parentNode));if(i)return n.preventDefault(),n.stopPropagation(),n.shiftKey?d(a):f(a),!1}},!0)}return{_init:u,format:l,refresh:p}},e.FE.RegisterCommand("formatUL",{title:"Unordered List",refresh:function(e){this.lists.refresh(e,"UL")},callback:function(){this.lists.format("UL")},plugin:"lists"}),e.FE.RegisterCommand("formatOL",{title:"Ordered List",refresh:function(e){this.lists.refresh(e,"OL")},callback:function(){this.lists.format("OL")},plugin:"lists"}),e.FE.DefineIcon("formatUL",{NAME:"list-ul"}),e.FE.DefineIcon("formatOL",{NAME:"list-ol"})}),!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof module&&module.exports?module.exports=function(t,n){return void 0===n&&(n="undefined"!=typeof window?require("jquery"):require("jquery")(t)),e(n),n}:e(jQuery)}(function(e){"use strict";e.extend(e.FE.POPUP_TEMPLATES,{"link.edit":"[_BUTTONS_]","link.insert":"[_BUTTONS_][_INPUT_LAYER_]"}),e.extend(e.FE.DEFAULTS,{linkEditButtons:["linkOpen","linkStyle","linkEdit","linkRemove"],linkInsertButtons:["linkBack","|","linkList"],linkAttributes:{},linkAutoPrefix:"http://",linkStyles:{"fr-green":"Green","fr-strong":"Thick"},linkMultipleStyles:!0,linkConvertEmailAddress:!0,linkAlwaysBlank:!1,linkAlwaysNoFollow:!1,linkList:[{text:"Froala",href:"https://froala.com",target:"_blank"},{text:"Google",href:"https://google.com",target:"_blank"},{displayText:"Facebook",href:"https://facebook.com"}],linkText:!0}),e.FE.PLUGINS.link=function(t){function n(){var n=t.image?t.image.get():null;if(!n&&t.$wp){var i=t.selection.element(),r=t.selection.endElement();return"A"!=i.tagName&&(i=e(i).parents("a:first").get(0)),"A"!=r.tagName&&(r=e(r).parents("a:first").get(0)),r&&r==i?i:null}return"A"==t.$el.get(0).tagName&&t.core.hasFocus()?t.$el:n&&n.get(0).parentNode&&"A"==n.get(0).parentNode.tagName?n.get(0).parentNode:void 0}function i(){var e=t.image?t.image.get():null,n=[];if(e)"A"==e.get(0).parentNode.tagName&&n.push(e.get(0).parentNode);else{var i,r,a,s;if(t.win.getSelection){var o=t.win.getSelection();if(o.getRangeAt&&o.rangeCount){s=t.doc.createRange();for(var l=0;l<o.rangeCount;++l)if(i=o.getRangeAt(l),r=i.commonAncestorContainer,r&&1!=r.nodeType&&(r=r.parentNode),r&&"a"==r.nodeName.toLowerCase())n.push(r);else{a=r.getElementsByTagName("a");for(var p=0;p<a.length;++p)s.selectNodeContents(a[p]),s.compareBoundaryPoints(i.END_TO_START,i)<1&&s.compareBoundaryPoints(i.START_TO_END,i)>-1&&n.push(a[p])}}}else if(t.doc.selection&&"Control"!=t.doc.selection.type)if(i=t.doc.selection.createRange(),r=i.parentElement(),"a"==r.nodeName.toLowerCase())n.push(r);else{a=r.getElementsByTagName("a"),s=t.doc.body.createTextRange();for(var f=0;f<a.length;++f)s.moveToElementText(a[f]),s.compareEndPoints("StartToEnd",i)>-1&&s.compareEndPoints("EndToStart",i)<1&&n.push(a[f])}}return n}function r(i){t.popups.hide("link.edit"),setTimeout(function(){if(!i||i&&(1==i.which||"mouseup"!=i.type)){var r=n(),s=t.image?t.image.get():null;if(r&&!s){if(t.image){var o=t.node.contents(r);if(1==o.length&&"IMG"==o[0].tagName){var l=t.selection.ranges(0);return 0===l.startOffset&&0===l.endOffset?e(r).before(e.FE.MARKERS):e(r).after(e.FE.MARKERS),t.selection.restore(),!1}}i&&i.stopPropagation(),a(r)}}},t.helpers.isIOS()?100:0)}function a(n){var i=t.popups.get("link.edit");i||(i=o());var r=e(n);t.popups.isVisible("link.edit")||t.popups.refresh("link.edit"),t.popups.setContainer("link.edit",e(t.opts.scrollableContainer));var a=r.offset().left+e(n).outerWidth()/2,s=r.offset().top+r.outerHeight();t.popups.show("link.edit",a,s,r.outerHeight())}function s(){t.popups.hide("link.edit")}function o(){var e="";t.opts.linkEditButtons.length>1&&("A"==t.$el.get(0).tagName&&t.opts.linkEditButtons.indexOf("linkRemove")>=0&&t.opts.linkEditButtons.splice(t.opts.linkEditButtons.indexOf("linkRemove"),1),e='<div class="fr-buttons">'+t.button.buildList(t.opts.linkEditButtons)+"</div>");var i={buttons:e},r=t.popups.create("link.edit",i);return t.$wp&&t.events.$on(t.$wp,"scroll.link-edit",function(){n()&&t.popups.isVisible("link.edit")&&a(n())}),r}function l(){}function p(){var i=t.popups.get("link.insert"),r=n();if(r){var a,s,o=e(r),l=i.find('input.fr-link-attr[type="text"]'),p=i.find('input.fr-link-attr[type="checkbox"]');for(a=0;a<l.length;a++)s=e(l[a]),s.val(o.attr(s.attr("input-name")||""));for(p.prop("checked",!1),a=0;a<p.length;a++)s=e(p[a]),o.attr(s.attr("input-name"))==s.data("checked")&&s.prop("checked",!0);i.find('input.fr-link-attr[type="text"][input-name="text"]').val(o.text())}else i.find('input.fr-link-attr[type="text"]').val(""),i.find('input.fr-link-attr[type="checkbox"]').prop("checked",!1),i.find('input.fr-link-attr[type="text"][input-name="text"]').val(t.selection.text());i.find("input.fr-link-attr").trigger("change");var f=t.image?t.image.get():null;f?i.find('.fr-link-attr[input-name="text"]').parent().hide():i.find('.fr-link-attr[input-name="text"]').parent().show()}function f(){var n=t.$tb.find('.fr-command[data-cmd="insertLink"]'),i=t.popups.get("link.insert");if(i||(i=d()),!i.hasClass("fr-active"))if(t.popups.refresh("link.insert"),t.popups.setContainer("link.insert",t.$tb||e(t.opts.scrollableContainer)),n.is(":visible")){var r=n.offset().left+n.outerWidth()/2,a=n.offset().top+(t.opts.toolbarBottom?10:n.outerHeight()-10);t.popups.show("link.insert",r,a,n.outerHeight())}else t.position.forSelection(i),t.popups.show("link.insert")}function d(e){if(e)return t.popups.onRefresh("link.insert",p),t.popups.onHide("link.insert",l),!0;var i="";t.opts.linkInsertButtons.length>=1&&(i='<div class="fr-buttons">'+t.button.buildList(t.opts.linkInsertButtons)+"</div>");var r='<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10" height="10" viewBox="0 0 32 32"><path d="M27 4l-15 15-7-7-5 5 12 12 20-20z" fill="#FFF"></path></svg>',a="",s=0;a='<div class="fr-link-insert-layer fr-layer fr-active" id="fr-link-insert-layer-'+t.id+'">',a+='<div class="fr-input-line"><input input-name="href" type="text" class="fr-link-attr" placeholder="URL" tabIndex="'+ ++s+'"></div>',t.opts.linkText&&(a+='<div class="fr-input-line"><input input-name="text" type="text" class="fr-link-attr" placeholder="'+t.language.translate("Text")+'" tabIndex="'+ ++s+'"></div>');for(var o in t.opts.linkAttributes)if(t.opts.linkAttributes.hasOwnProperty(o)){var f=t.opts.linkAttributes[o];a+='<div class="fr-input-line"><input input-name="'+o+'" type="text" class="fr-link-attr" placeholder="'+t.language.translate(f)+'" tabIndex="'+ ++s+'"></div>'}t.opts.linkAlwaysBlank||(a+='<div class="fr-checkbox-line"><span class="fr-checkbox"><input input-name="target" class="fr-link-attr" data-checked="_blank" type="checkbox" id="fr-link-target-'+t.id+'" tabIndex="'+ ++s+'"><span>'+r+'</span></span><label for="fr-link-target-'+t.id+'">'+t.language.translate("Open in new tab")+"</label></div>"),a+='<div class="fr-action-buttons"><button class="fr-command fr-submit" data-cmd="linkInsert" href="#" tabIndex="'+ ++s+'" type="button">'+t.language.translate("Insert")+"</button></div></div>";var d={buttons:i,input_layer:a},c=t.popups.create("link.insert",d);return t.$wp&&t.events.$on(t.$wp,"scroll.link-insert",function(){var e=t.image?t.image.get():null;e&&t.popups.isVisible("link.insert")&&E(),n&&t.popups.isVisible("link.insert")&&v()}),c}function c(){var i=n(),r=t.image?t.image.get():null;return t.events.trigger("link.beforeRemove",[i])===!1?!1:void(r&&i?(r.unwrap(),t.image.edit(r)):i&&(t.selection.save(),e(i).replaceWith(e(i).html()),t.selection.restore(),s()))}function u(){t.events.on("keyup",function(t){t.which!=e.FE.KEYCODE.ESC&&r(t)}),t.events.on("window.mouseup",r),t.events.$on(t.$doc,"selectionchange",r),d(!0),"A"==t.$el.get(0).tagName&&t.$el.addClass("fr-view")}function g(n){var i,r,a=t.opts.linkList[n],s=t.popups.get("link.insert"),o=s.find('input.fr-link-attr[type="text"]'),l=s.find('input.fr-link-attr[type="checkbox"]');for(r=0;r<o.length;r++)i=e(o[r]),a[i.attr("input-name")]?i.val(a[i.attr("input-name")]):"text"!=i.attr("input-name")&&i.val("");for(r=0;r<l.length;r++)i=e(l[r]),i.prop("checked",i.data("checked")==a[i.attr("input-name")])}function h(){var n,i,r=t.popups.get("link.insert"),a=r.find('input.fr-link-attr[type="text"]'),s=r.find('input.fr-link-attr[type="checkbox"]'),o=a.filter('[input-name="href"]').val(),l=a.filter('[input-name="text"]').val(),p={};for(i=0;i<a.length;i++)n=e(a[i]),["href","text"].indexOf(n.attr("input-name"))<0&&(p[n.attr("input-name")]=n.val());for(i=0;i<s.length;i++)n=e(s[i]),n.is(":checked")?p[n.attr("input-name")]=n.data("checked"):p[n.attr("input-name")]=n.data("unchecked");var f=e(t.o_win).scrollTop();k(o,l,p),e(t.o_win).scrollTop(f)}function m(){if(!t.selection.isCollapsed()){t.selection.save();for(var n=t.$el.find(".fr-marker").addClass("fr-unprocessed").toArray();n.length;){var i=e(n.pop());i.removeClass("fr-unprocessed");var r=t.node.deepestParent(i.get(0));if(r){var a=i.get(0),s="",o="";do a=a.parentNode,t.node.isBlock(a)||(s+=t.node.closeTagString(a),o=t.node.openTagString(a)+o);while(a!=r);var l=t.node.openTagString(i.get(0))+i.html()+t.node.closeTagString(i.get(0));i.replaceWith('<span id="fr-break"></span>');var p=e(r).html();p=p.replace(/<span id="fr-break"><\/span>/g,s+l+o),e(r).html(p)}n=t.$el.find(".fr-marker.fr-unprocessed").toArray()}t.selection.restore()}}function k(a,s,o){"undefined"==typeof o&&(o={});var l=t.image?t.image.get():null;l||"A"==t.$el.get(0).tagName?"A"==t.$el.get(0).tagName&&t.$el.focus():(t.selection.restore(),t.popups.hide("link.insert"));var p=a;if(t.opts.linkConvertEmailAddress){var f=/^[\w._]+@[a-zA-Z0-9_-]+?\.[a-zA-Z0-9]{2,3}$/i;f.test(a)&&0!==a.indexOf("mailto:")&&(a="mailto:"+a)}if(0===a.indexOf("tel:")||0===a.indexOf("sms:")||0===a.indexOf("mailto:")||0===a.indexOf("notes:")||0===a.indexOf("data:image")||""===t.opts.linkAutoPrefix||/^(https?:|ftps?:|)\/\//.test(a)||(a=t.opts.linkAutoPrefix+a),a=t.helpers.sanitizeURL(a),t.opts.linkAlwaysBlank&&(o.target="_blank"),t.opts.linkAlwaysNoFollow&&(o.rel="nofollow"),s=s||"",a===t.opts.linkAutoPrefix){var d=t.popups.get("link.insert");return d.find('input[input-name="href"]').addClass("fr-error"),t.events.trigger("link.bad",[p]),!1}var c,u=n();if(u){c=e(u);var g=t.node.rawAttributes(u);for(var h in g)g.hasOwnProperty(h)&&"class"!=h&&"style"!=h&&c.removeAttr(h);c.attr("href",a),s.length>0&&c.text()!=s&&!l&&c.text(s),l||c.prepend(e.FE.START_MARKER).append(e.FE.END_MARKER),c.attr(o),l||t.selection.restore()}else{l?l.wrap('<a href="'+a+'"></a>'):(t.doc.execCommand("unlink",!1,!1),t.selection.isCollapsed()?(s=0===s.length?p:s,t.html.insert('<a href="'+a+'">'+e.FE.START_MARKER+s+e.FE.END_MARKER+"</a>"),t.selection.restore()):s.length>0&&s!=t.selection.text()?(t.selection.remove(),t.html.insert('<a href="'+a+'">'+e.FE.START_MARKER+s+e.FE.END_MARKER+"</a>"),t.selection.restore()):(m(),t.doc.execCommand("createLink",!1,a)));for(var k=i(),v=0;v<k.length;v++)c=e(k[v]),c.attr(o),c.removeAttr("_moz_dirty");1==k.length&&t.$wp&&!l&&(e(k[0]).prepend(e.FE.START_MARKER).append(e.FE.END_MARKER),t.selection.restore())}if(l){var b=t.popups.get("link.insert");b.find("input:focus").blur(),t.image.edit(l)}else r()}function v(){s();var i=n();if(i){var r=t.popups.get("link.insert");r||(r=d()),t.popups.isVisible("link.insert")||(t.popups.refresh("link.insert"),t.selection.save(),t.helpers.isMobile()&&(t.events.disableBlur(),t.$el.blur(),t.events.enableBlur())),t.popups.setContainer("link.insert",e(t.opts.scrollableContainer));var a=(t.image?t.image.get():null)||e(i),o=a.offset().left+a.outerWidth()/2,l=a.offset().top+a.outerHeight();t.popups.show("link.insert",o,l,a.outerHeight())}}function b(){var e=t.image?t.image.get():null;if(e)t.image.back();else{t.events.disableBlur(),t.selection.restore(),t.events.enableBlur();var i=n();i&&t.$wp?(t.selection.restore(),s(),r()):"A"==t.$el.get(0).tagName?(t.$el.focus(),r()):(t.popups.hide("link.insert"),t.toolbar.showInline())}}function E(){var n=t.image?t.image.get():null;if(n){var i=t.popups.get("link.insert");i||(i=d()),p(!0),t.popups.setContainer("link.insert",e(t.opts.scrollableContainer));var r=n.offset().left+n.outerWidth()/2,a=n.offset().top+n.outerHeight();t.popups.show("link.insert",r,a,n.outerHeight())}}function x(i,a,s){"undefined"==typeof s&&(s=t.opts.linkMultipleStyles),"undefined"==typeof a&&(a=t.opts.linkStyles);var o=n();if(!o)return!1;if(!s){var l=Object.keys(a);l.splice(l.indexOf(i),1),e(o).removeClass(l.join(" "))}e(o).toggleClass(i),r()}return{_init:u,remove:c,showInsertPopup:f,usePredefined:g,insertCallback:h,insert:k,update:v,get:n,allSelected:i,back:b,imageLink:E,applyStyle:x}},e.FE.DefineIcon("insertLink",{NAME:"link"}),e.FE.RegisterShortcut(75,"insertLink"),e.FE.RegisterCommand("insertLink",{title:"Insert Link",undo:!1,focus:!0,refreshOnCallback:!1,popup:!0,callback:function(){this.popups.isVisible("link.insert")?(this.$el.find(".fr-marker")&&(this.events.disableBlur(),this.selection.restore()),this.popups.hide("link.insert")):this.link.showInsertPopup()},plugin:"link"}),e.FE.DefineIcon("linkOpen",{NAME:"external-link"}),e.FE.RegisterCommand("linkOpen",{title:"Open Link",undo:!1,refresh:function(e){var t=this.link.get();t?e.removeClass("fr-hidden"):e.addClass("fr-hidden")},callback:function(){var e=this.link.get();e&&this.o_win.open(e.href)}}),e.FE.DefineIcon("linkEdit",{NAME:"edit"}),e.FE.RegisterCommand("linkEdit",{title:"Edit Link",undo:!1,refreshAfterCallback:!1,callback:function(){this.link.update()},refresh:function(e){var t=this.link.get();t?e.removeClass("fr-hidden"):e.addClass("fr-hidden")}}),e.FE.DefineIcon("linkRemove",{NAME:"unlink"}),e.FE.RegisterCommand("linkRemove",{title:"Unlink",callback:function(){this.link.remove()},refresh:function(e){var t=this.link.get();t?e.removeClass("fr-hidden"):e.addClass("fr-hidden")}}),e.FE.DefineIcon("linkBack",{NAME:"arrow-left"}),e.FE.RegisterCommand("linkBack",{title:"Back",undo:!1,focus:!1,back:!0,refreshAfterCallback:!1,callback:function(){this.link.back()},refresh:function(e){var t=this.link.get(),n=this.image?this.image.get():null;n||t||this.opts.toolbarInline?(e.removeClass("fr-hidden"),e.next(".fr-separator").removeClass("fr-hidden")):(e.addClass("fr-hidden"),e.next(".fr-separator").addClass("fr-hidden"))}}),e.FE.DefineIcon("linkList",{NAME:"search"}),e.FE.RegisterCommand("linkList",{title:"Choose Link",type:"dropdown",focus:!1,undo:!1,refreshAfterCallback:!1,html:function(){for(var e='<ul class="fr-dropdown-list">',t=this.opts.linkList,n=0;n<t.length;n++)e+='<li><a class="fr-command" data-cmd="linkList" data-param1="'+n+'">'+(t[n].displayText||t[n].text)+"</a></li>";return e+="</ul>"},callback:function(e,t){this.link.usePredefined(t)}}),e.FE.RegisterCommand("linkInsert",{focus:!1,refreshAfterCallback:!1,callback:function(){this.link.insertCallback()},refresh:function(e){var t=this.link.get();t?e.text(this.language.translate("Update")):e.text(this.language.translate("Insert"))}}),e.FE.DefineIcon("imageLink",{NAME:"link"}),e.FE.RegisterCommand("imageLink",{title:"Insert Link",undo:!1,focus:!1,callback:function(){this.link.imageLink()},refresh:function(e){var t,n=this.link.get();n?(t=e.prev(),t.hasClass("fr-separator")&&t.removeClass("fr-hidden"),e.addClass("fr-hidden")):(t=e.prev(),t.hasClass("fr-separator")&&t.addClass("fr-hidden"),e.removeClass("fr-hidden"))}}),e.FE.DefineIcon("linkStyle",{NAME:"magic"}),e.FE.RegisterCommand("linkStyle",{title:"Style",type:"dropdown",html:function(){var e='<ul class="fr-dropdown-list">',t=this.opts.linkStyles;for(var n in t)t.hasOwnProperty(n)&&(e+='<li><a class="fr-command" data-cmd="linkStyle" data-param1="'+n+'">'+this.language.translate(t[n])+"</a></li>");return e+="</ul>"},callback:function(e,t){this.link.applyStyle(t)},refreshOnShow:function(t,n){var i=this.link.get();if(i){var r=e(i);n.find(".fr-command").each(function(){var t=e(this).data("param1");e(this).toggleClass("fr-active",r.hasClass(t))})}}})});