...
class Site_Logo_Image_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'site-logo-control', LAYERS_TEMPLATE_URI . '/core/third-party/site-logo/css/site-logo-control.css' );
		wp_enqueue_script( 'site-logo-control', LAYERS_TEMPLATE_URI . '/core/third-party/site-logo/js/site-logo-control.js', array( 'media-views', 'customize-controls', 'underscore' ), '', true );
	}
