<div class="feature-section three-col">
	...
	<div class="col">
		<h3><i class="dashicons dashicons-portfolio"></i><?php esc_html_e( 'Changelog', 'shapely' ); ?></h3>
		<p>
			<i><?php esc_html_e( 'Want to get the gist on the latest theme changes? Just consult our changelog below to get a taste of the recent fixes and features implemented.', 'shapely' ) ?></i>
		</p>
		<p>
			<a href="<?php echo esc_url( admin_url( 'themes.php?page=shapely-welcome&tab=changelog' ) ); ?>"><?php esc_html_e( 'See changelog', 'shapely' ); ?></a>
		</p>
	</div><!--/.col-->
</div><!--/.feature-section-->
